...
- *Scenes* folder: This folder contains sub-folders for each separate scene in the project. Each scene should contain a *Level* and possibly a *Sequence* if it's relevant to your design.
...
- *Stage* folder: This folder contains all the technical assets related to the physical stage like LED Reference Geometry, XRCameras, and Example Tutorials. You should not need to modify anything in here.
